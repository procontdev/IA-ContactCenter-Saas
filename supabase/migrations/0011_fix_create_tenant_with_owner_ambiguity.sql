-- Migration: 0011_fix_create_tenant_with_owner_ambiguity
-- Description: Corrige ambigüedad de tenant_id en create_tenant_with_owner para validación funcional real.
...
BEGIN
    ...
    IF v_tenant_id IS NULL THEN
        ...
        VALUES (
            ...
            v_slug,
            true,
            jsonb_build_object('source', '0011_fix_create_tenant_with_owner_ambiguity', 'owner_user_id', v_user_id)
        )
    ...
    FROM platform_core.tenant_users AS tu
    INNER JOIN platform_core.tenants AS t ON t.id = tu.tenant_id
    WHERE tu.user_id = v_user_id
      AND tu.tenant_id = v_tenant_id
    LIMIT 1;
END;
