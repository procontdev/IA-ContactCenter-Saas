...
async function main() {
    ...
    const tempEmail = String(process.env.SMOKE_CAMPAIGN_SETTINGS_AGENT_EMAIL || `demo.campaign.settings.${Date.now()}@local.test`);
    const tempPassword = String(process.env.SMOKE_CAMPAIGN_SETTINGS_AGENT_PASSWORD || 'DemoAgent123!');
